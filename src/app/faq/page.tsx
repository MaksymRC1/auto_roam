...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Система автоматично визначає, чи перетинає ваш маршрут державні кордони. Якщо ви виїжджаєте за межі Шенгенської зони (або навпаки), ми автоматично додаємо відповідні прикордонні пункти та закладаємо середній час на проходження контролю. Зверніть увагу: час очікування є орієнтовним та може суттєво залежати від часу доби та сезону."
  },
  {
    id: "fuel",
